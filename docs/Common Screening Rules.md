...
- H02: 近 N 期 XXX 有 M 期 > T          (各期比較)             
       近 N 期 XXX 最少 > T             (連續)
       近 N 期 XXX > T                  (連續)  
       XXX 連續 M 期 > T 
- H03: 近 N 期 XXX 成長幅度有 M 期 > T  (計算各期成長幅度)
       n-MA XXX 連續 M 期成長           (各期遞增)        
- H04: 近 N 期間 XXX 成長幅度 > T       (期間成長幅度)   
       n-MA XXX 成長幅度 > T            (最新一期)
- H05: 近 N 期 XXX > 近 M 期平均        (各期 > 平均)  
       最新 XXX > 近 M 期平均
- H06: 近 N 期 XXX 平均 > T             (期間平均)                    
...
- H02_04: 營收年增率連續 M 個月 > T%                 list_revenue_yoy_above
- H02_05: 近 N 季營業利益率最少 > T%  (全部)         list_opr_margin_above
- H02_06: 近 N 季營業利益率季增率 > T%  (全部)       list_opr_margin_qoq_above
- H02_07: 近 N 季營業利益率年增率 > T%  (全部)       list_opr_margin_yoy_above
- H03_08: N 個月平均(MA)營收連續 M 個月成長  (數值遞增)              list_revenue_ma_growth
- H03_09: N 個月平均(MA)累積營收年增率連續 M 個月成長  (年增率遞增)  list_accum_revenue_yoy_ma_growth
- H04_10: (最新一期) N 個月平均(MA)累積營收年增率成長幅度 > T%  (年增率遞增幅度)  list_accum_revenue_yoy_ma_growth_above
- H04_11: 近 N 個月股價成長幅度 > T%  (N 個月期間)   list_price_growth_above
- H05_12: 最新股價 > 近 N 個月月均價                 list_price_above_avg
- H06_13: 近 N 季稅後純益率平均 > T%                 list_net_margin_avg_above
- H07_14: 近 N 季營業利益率最小/最大 > T%            list_opr_margin_min_max_ratio_above

組合:
1. _穩定型成長股 (營收選股 - 營收成長趨勢、獲利指標持穩或上升）_

- H03_08: 12 個月平均(MA)營收連續 2 個月成長
- H02_04: 營收年增率連續 1 個月 > 40%
- H07_14: 近 8 季營業利益率最小/最大 > 60%
  or
  H01_02: 近 1 季營業利益率為近 8 季最大
  or
  H02_07: 近 2 季營業利益率年增率 > 0%
  or 
  H02_06: 近 3 季營業利益率季增率 > 0%
- H06_13: 近 1 季稅後純益率平均 > 0%
- H02_05: 近 4 季營業利益率最少 > 0%

2. _長期強勢成長股（營收創新高、股價多頭趨勢）_

- H01_01: 近 2 個月營收創近 12 個月新高
- H04_11: 6 個月股價成長幅度 > 25% (or 0%)

3. _短期強勢成長股（營收上升、股價走強）_

- H02_03: 營收月增率連續 1 個月 > 0%
- H03_09: 3 個月平均(MA)累積營收年增率連續 1 個月成長
- H04_11: 近 6 個月股價成長幅度 > 0%
...
- H03_08: 12 個月平均(MA)營收連續 1 個月成長
- H02_04: 營收年增率連續 1 個月 > 35%
- H03_09: 12 個月平均(MA)累積營收年增率連續 1 個月成長
- H04_10: (最新一期) 12 個月平均(MA)累積營收年增率成長幅度 > 2%
